...
def mgr_snapshot_cmd(module, module_args, snapset_json):
    ...
    if check_mode:
        return {"return_code": rc, "errors": "Would call function manager.create_snapshot_set()", "changed": False}
...
def mgr_extend_cmd(module, module_args, snapset_json):
    ...
    if check_mode:
        return {
            "return_code": rc,
            "errors": "Would run function manager.resize_snapshot_set() with " + ", ".join(source_list),
            "changed": False,
        }
...
def mgr_revert_cmd(module_args, snapset_json):
    ...
    if check_mode:
        return {
            "return_code": rc,
            "errors": "Would run function manager.revert_snapshot_set with " + snapset_name,
            "changed": False,
        }
